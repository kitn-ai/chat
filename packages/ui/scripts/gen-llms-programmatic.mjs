...
//
// The section is written into llms-full.txt by gen-llms.mjs and ALSO to
// dist/llms/programmatic.md, which is what the MCP's
// `component_reference({ name: "programmatic" })` topic serves — one
