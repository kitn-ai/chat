// The composed support widget's main.ts, ported to what a no-bundler CDN page
// can actually do. Plain JS (no TS on this path — finding), loader chosen by
// the page that imports this. `/kit/` stands in for
// https://cdn.jsdelivr.net/npm/@kitn.ai/ui@<version>/dist/ — same files, same
// relative layout, served from the freshly built local dist.
