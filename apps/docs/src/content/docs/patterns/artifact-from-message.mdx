...
chat.messages = [
  {
    ...
    role: 'assistant',
    parts: [
      // the generated file, shown as a chip in the message (a `file` part)
      { type: 'file', attachment: { id: 'starboard-html', type: 'file', filename: 'index.html', title: 'Starboard landing page' } },
      { type: 'text', text: "Here's a landing page for Starboard…" },
    ],
